...
quiz <- function(protein = "random", reveal = T) {
	...
	# - n, the total number of words in all proteins' function summaries
	# - k, the number of words in response
	score <- round(phyper(q - 1, m, n - m, median_words, lower.tail = T), 4) * 100
	...
	# Also reveal answer?
	answer <- ""
	if(reveal) answer <- paste0("Answer: ", random_protein$protein_function)
